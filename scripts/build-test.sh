#!/usr/bin/env bash
#
# Build the Monopoly .self / .pkg WITH the e2e test-harness TCP server compiled in
...
# between a normal build and a test build would otherwise leave objects compiled
